...
import soph from "../assets/soph.jpg";
...
const people = [
  {
    ...
    role: 'Senior Manager',
    imageUrl: soph,
    bio: 'Sophie has been working at Cavalier for almost ten years.  Her main role is taking naps but she will alert the staff if sales reps enter the building without an appointment.  If her free time, Sophie enjoys swimming and wearing lion costumes.',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
  // More people...
